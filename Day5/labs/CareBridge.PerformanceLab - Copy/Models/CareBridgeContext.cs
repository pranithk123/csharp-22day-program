...
public partial class CareBridgeContext : DbContext
{
    ...
    public virtual DbSet<BillingClaimView> BillingClaimViews { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    {
        modelBuilder.Entity<BillingClaimView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Billing_Claim_View");
        ...
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__Claim__EF2E139BABA014DD");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED0A970624");
        ...
        {
            entity.HasKey(e => e.DiagnosisId).HasName("PK__Diagnosi__0C54CC73DBFE445E");
        ...
        {
            entity.HasKey(e => e.EncounterId).HasName("PK__Encounte__4278DD366334B761");
        ...
        {
            entity.HasKey(e => e.InsuranceId).HasName("PK__Insuranc__74231A242AED4CDF");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patient__970EC366466C071D");
            ...
            entity.HasIndex(e => e.Mrn, "UQ__Patient__C790FDB4C345A9F8").IsUnique();
        ...
        {
            entity.HasKey(e => e.ProcedureId).HasName("PK__Procedur__54C2E52D74B144E0");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687DD0F9BD1E");
